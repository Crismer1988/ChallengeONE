...
//Funcion de desencriptado en dos pasos.
...
document.getElementById("encryptBtn").addEventListener("click", function() {
    ...
    if (input.trim() === "") {
        emptyInputAlerts("question", "Ups!", "Por favor, introduce el texto que quieres encriptar.");
        decryptArea__init.style.display = "block";
    } else {
        encryptionAlerts("success", "Genial!", "El texto ha sido encriptado exitosamente.");
